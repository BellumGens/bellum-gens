...
import { IgxDialogComponent, IgxButtonModule, IgxRippleModule, IgxDialogModule, IgxInputGroupModule, IgxSuffixModule, IgxIconModule } from '@infragistics/igniteui-angular';
import {
  ApplicationUser,
...
@Component({
    ...
    standalone: true,
    imports: [IgxButtonModule, IgxRippleModule, IgxDialogModule, IgxInputGroupModule, FormsModule, NgIf, IgxSuffixModule, IgxIconModule]
})
