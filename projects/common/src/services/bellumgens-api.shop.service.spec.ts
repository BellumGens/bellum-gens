...
describe('ApiShopService', () => {
  ...
  describe('submitOrder', () => {
    it('should send a POST request to the API with the order data', () => {
      const order: Order = { orderProducts: [{ cut: JerseyCut.Male, size: JerseySize.L } as ProductOrderDetails] };
  ...
  describe('confirmOrder', () => {
    it('should send a PUT request to the API with the order data', () => {
      const order: Order = { id: '123', orderProducts: [{ cut: JerseyCut.Male, size: JerseySize.L } as ProductOrderDetails] };
